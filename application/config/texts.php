...
return array(
    ...
    "FEEDBACK_GALLERY_UPLOAD_SUCCESSFUL" => "File uploaded successfully.",
    "FEEDBACK_GALLERY_UPLOAD_FAILED" => "File upload failed. Please try again.",
    "FEEDBACK_GALLERY_UPLOAD_TOO_BIG" => "File is too large. Maximum allowed size is 5 MB.",
    "FEEDBACK_GALLERY_UPLOAD_WRONG_TYPE" => "Only JPEG, PNG and GIF images are allowed.",
    "FEEDBACK_GALLERY_UPLOAD_NO_FILE" => "No file was selected for upload.",
    "FEEDBACK_GALLERY_FOLDER_NOT_WRITABLE" => "Upload folder does not exist or is not writable.",
    "FEEDBACK_GALLERY_DELETE_SUCCESSFUL" => "File deleted successfully.",
    "FEEDBACK_GALLERY_DELETE_FAILED" => "File deletion failed. You may not have permission to delete this file.",
    "FEEDBACK_GALLERY_SHARE_TOGGLED" => "Sharing status has been updated.",
    "FEEDBACK_GALLERY_SHARE_FAILED" => "Could not update sharing status.",
    "FEEDBACK_GALLERY_FILE_NOT_FOUND" => "The requested file was not found.",
    "FEEDBACK_GALLERY_ACCESS_DENIED" => "Access denied. You do not have permission to access this file.",
    "FEEDBACK_VIDEO_UPLOAD_SUCCESSFUL" => "Video uploaded successfully.",
    "FEEDBACK_VIDEO_UPLOAD_FAILED" => "Video upload failed. Please try again.",
    "FEEDBACK_VIDEO_UPLOAD_TOO_BIG" => "Video file is too large. Maximum allowed size is 200 MB.",
    "FEEDBACK_VIDEO_UPLOAD_WRONG_TYPE" => "Only MP4, WebM and OGG videos are allowed.",
    "FEEDBACK_VIDEO_UPLOAD_NO_FILE" => "No video file was selected for upload.",
    "FEEDBACK_VIDEO_UPLOAD_NO_TITLE" => "Please enter a title for your video.",
    "FEEDBACK_VIDEO_FOLDER_NOT_WRITABLE" => "Upload folder does not exist or is not writable.",
    "FEEDBACK_VIDEO_DELETE_SUCCESSFUL" => "Video deleted successfully.",
    "FEEDBACK_VIDEO_DELETE_FAILED" => "Video deletion failed. You may not have permission to delete this video.",
    "FEEDBACK_VIDEO_PUBLISH_TOGGLED" => "Video publish status has been updated.",
    "FEEDBACK_VIDEO_PUBLISH_FAILED" => "Could not update video publish status.",
    "FEEDBACK_VIDEO_CHUNK_INVALID" => "Invalid chunk upload request.",
    "FEEDBACK_VIDEO_CHUNK_WRITE_FAILED" => "Failed to write video chunk. Please try again.",
    "FEEDBACK_VIDEO_UPLOAD_TOO_BIG_CHUNKED" => "Video file is too large. Maximum allowed size is 10 GB.",
    "FEEDBACK_VIDEO_CHUNK_FINALIZE_FAILED" => "Failed to finalize video upload. Please try again.",
    "FEEDBACK_COMMENT_EMPTY" => "Comment cannot be empty.",
    "FEEDBACK_COMMENT_TOO_LONG" => "Comment is too long. Maximum 1000 characters.",
    "FEEDBACK_COMMENT_ADD_SUCCESSFUL" => "Comment posted.",
    "FEEDBACK_COMMENT_ADD_FAILED" => "Could not post comment. Please try again.",
    "FEEDBACK_COMMENT_DELETE_SUCCESSFUL" => "Comment deleted.",
    "FEEDBACK_COMMENT_DELETE_FAILED" => "Could not delete comment. You may not have permission.",
);
